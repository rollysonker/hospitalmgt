...
import com.rolly.practice.hospitalmgt.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.rolly.practice.hospitalmgt.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
